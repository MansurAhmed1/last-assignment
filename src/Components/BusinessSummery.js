...
const BusinessSummery = () => {
  return (
    <div className="my-36">
      <h1 className="text-4xl text-teal-600  font-bold text-center">MILIONS BUSINESS TRUST US</h1>
      
      
      <h1 className="text-xl pt-2 font-bold text-center">TRY TO UNDERSTAND USER EXPECTATION</h1>
      <div class="divider w-1/2 mx-auto"> </div>
      <div class="stats py-8 flex  justify-between stats-vertical lg:stats-horizontal rounded-none shadow w-full">
        <div class="stat">
     ...
     "
        ...
        <div class="stat">
          ...
          <div class="stat-value text-secondary">2.6
        ...
        <div class="stat">
          ...
          <div class="stat-desc">1M Served this month</div>
        </div>
          ...
          <div class="stat-figure text-secondary">
            <div class="avatar online">
              <div class="w-16 rounded-full">
                <img src="https://cdn-icons-png.flaticon.com/512/10/10957.png" alt="" />
              </div>
            </div>
          </div>
