...
const Banner = () => {
  return (
    ...
    >
      {/* <!-- Carousel wrapper --> */}
      <div class=" duration-700 ease-in-out   overflow-hidden relative h-full">
        {/* <!-- Item 1 --> */}
        <div class="hidden duration-700 ease-in-out h-full" data-carousel-item>
          <div class="hero h-full bg-zinc-900 text-white">
            <div class="hero-content flex-col lg:flex-row-reverse justify-center items-center w-11/12 mx-auto">
              <img
        ...
        >
          <div class="hero h-full bg-base-200 ">
            <div class="hero-content flex-col lg:flex-row-reverse w-11/12  justify-center items-center  mx-auto">
              ...
              />
              <div>
                <h1 class="md:text-5xl text-2xl font-bold">Box Office News!</h1>
                <p class="py-6">
