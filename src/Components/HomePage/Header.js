...
const Header = () => {
  ...
  <div>
  <img className='h-6 w-44 ml-5 lg:ml-0' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQTcbehD5dhPR3c2dpf1Ei92D8AAp4zrhJYt6Tc06tF1BwYYgxVg-cp6zHIooNprk-Ezg&usqp=CAU" alt='' />
            ...
            <div className='navRight'>
              ...
              {user ? (
               ...
               <div className='block toggleButton lg:hidden w-8 h-8' onClick={()=>{
                ...
                <img  src={navTrigger ? 'https://cdn-icons.flaticon.com/png/512/2889/premium/2889724.png?token=exp=1656416539~hmac=a6019334df2994ecd7d479adfef8e265' : 'https://cdn-icons-png.flaticon.com/128/1828/1828551.png' } className='w-8 h-8 ' alt="menuicon" />
               </div>
            </div>
        </div >
        <div  className={`smallMenu block z-40 lg:hidden pb-5  bg-teal-400   w-full absolute left-0 top-16 ${navTrigger?'block':'hidden'}  `} >
