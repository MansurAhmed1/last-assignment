...
// const MyPortFolio = () => {
//   return (
//     <div style={{ height: "100vh" }} className="px-6 text-left">
//       <p>Name:Mansur Ahmed</p>
//       <p>Email:mansurahmed75236@gmail.com</p>
//       <p>Educational Background:Honourse Secend Year (Bangla) Hatiya Dwip Government College.</p>
//       <p>My webdevolopment skill:</p>
  ...
  return (
    <div className=" grid gird-cols-1  justify-center items-center lg:grid-cols-2   mt-0  mx-5">
      ...
      <div className="font-semibold  pb-12 px-4 lg:px-0 py-6 lg:py-12 text-black  text-left text-lg">
        ...
        <p className="py-1 underline">   My webdevolopment skill: </p>  <ul className="list-disc px-8">
          <li>1.HTML</li>
          <li>2.CSS</li>
          <li>3.BOOTSTRAP</li>
          <li>4.TAILWIND</li>
